...
func TestListJobsStatusParityAcrossBuiltInRuntimes(t *testing.T) {
	...
	for _, harness := range jobdbtest.BuiltInRuntimeHarnesses() {
		...
		t.Run(harness.Name, func(t *testing.T) {
			compareAcrossModes(t, harness, []jobdb.WorkSet{completedWS, cancelWS}, func(t *testing.T, ctx context.Context, subject scenarioSubject) listJobsObservation {
...
func TestListJobsFilterParityAcrossBuiltInRuntimes(t *testing.T) {
	...
	for _, harness := range jobdbtest.BuiltInRuntimeHarnesses() {
		harness := harness
		t.Run(harness.Name, func(t *testing.T) {
			compareAcrossModes(t, harness, []jobdb.WorkSet{alphaWS, betaWS}, func(t *testing.T, ctx context.Context, subject scenarioSubject) filteredListObservation {
				tenantID := subject.built.WorkerTenantID
