...
func (jobFailedChainAppErrorChildJob) Run(_ jobdb.JobContext, _ jobdb.JobData) (jobdb.JobData, error) {
...
func (jobFailedChainGenericChildJob) Run(_ jobdb.JobContext, _ jobdb.JobData) (jobdb.JobData, error) {
...
func (jobFailedChainTaskChildJob) Run(ctx jobdb.JobContext, data jobdb.JobData) (jobdb.JobData, error) {
...
func (jobFailedChainTaskChildFailTask) Run(_ jobdb.TaskContext, _ jobdb.TaskData) (jobdb.TaskData, error) {
	return nil, fmt.Errorf("command execution failed: exit status 1")
}
...
func (j *jobFailedChainParentJob) Run(ctx jobdb.JobContext, data jobdb.JobData) (_ jobdb.JobData, runErr error) {
