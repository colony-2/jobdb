...
func waitForCompletedStatus(t *testing.T, ctx context.Context, engine jobdb.Engine, jobKey jobdb.JobKey) {
	t.Helper()
...
func (statusJobWorker) Run(ctx jobdb.JobContext, input jobdb.JobData) (jobdb.JobData, error) {
...
func (statusTaskWorker) Run(ctx jobdb.TaskContext, input jobdb.TaskData) (jobdb.TaskData, error) {
