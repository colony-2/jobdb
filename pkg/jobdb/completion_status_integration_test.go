...
func (completionSuccessWorker) Run(ctx jobdb.JobContext, input jobdb.JobData) (jobdb.JobData, error) {
	return input, nil
}
...
func (completionAppErrorWorker) Run(ctx jobdb.JobContext, input jobdb.JobData) (jobdb.JobData, error) {
...
func (completionSystemErrorWorker) Run(ctx jobdb.JobContext, input jobdb.JobData) (jobdb.JobData, error) {
...
func (completionTimeoutWorker) Run(ctx jobdb.JobContext, input jobdb.JobData) (jobdb.JobData, error) {
