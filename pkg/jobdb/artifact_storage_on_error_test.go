...
func (j *taskErrorWithArtifactsJob) Run(ctx jobdb.JobContext, input jobdb.JobData) (jobdb.JobData, error) {
...
func (t *errorWithArtifactsTask) Run(ctx jobdb.TaskContext, input jobdb.TaskData) (jobdb.TaskData, error) {
...
func (j *simpleRetryErrorJob) Run(ctx jobdb.JobContext, input jobdb.JobData) (jobdb.JobData, error) {
...
func (t *simpleRetryErrorTask) Run(ctx jobdb.TaskContext, input jobdb.TaskData) (jobdb.TaskData, error) {
	output := &jobdb.SimpleTaskData{
...
func (j *errorJobWithArtifacts) Run(ctx jobdb.JobContext, input jobdb.JobData) (jobdb.JobData, error) {
