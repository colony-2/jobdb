...
func TestNewArtifactFromBytes(t *testing.T) {
	data := []byte("test data")
	art := jobdb.NewArtifactFromBytes("test.txt", data)
...
func TestNewArtifactFromReader(t *testing.T) {
	...
	art := jobdb.NewArtifactFromReader("output.txt", reader, int64(len(data)))
...
func TestNewArtifactFromFile(t *testing.T) {
	...
	// Create artifact
	art, err := jobdb.NewArtifactFromFile("test.txt", path)
	require.NoError(t, err)
...
func TestNewArtifactFromFileNoCleanup(t *testing.T) {
	...
	art, err := jobdb.NewArtifactFromFileNoCleanup("test.txt", path)
	require.NoError(t, err)
...
func TestArtifactFromFile_NonExistent(t *testing.T) {
	art, err := jobdb.NewArtifactFromFile("test.txt", "/nonexistent/path/file.txt")
	assert.Error(t, err)
	assert.Nil(t, art)
...
func TestBytesArtifact_EmptyData(t *testing.T) {
	art := jobdb.NewArtifactFromBytes("empty.txt", []byte{})
...
func TestArtifactReaderWithCloser(t *testing.T) {
	...
	art := jobdb.NewArtifactFromReader("test.txt", reader, int64(len(data)))
...
func TestArtifactName_SpecialCharacters(t *testing.T) {
	...
	for _, name := range testCases {
		t.Run(name, func(t *testing.T) {
			art := jobdb.NewArtifactFromBytes(name, []byte("data"))
...
func TestFileArtifact_Directory(t *testing.T) {
	...
	art, err := jobdb.NewArtifactFromFile("dir", tmpDir)
...
func TestArtifactSize_Unknown(t *testing.T) {
	art := jobdb.NewArtifactFromReader("test.txt", strings.NewReader("data"), -1)
...
func TestArtifact_Bytes(t *testing.T) {
	...
	t.Run("bytes artifact", func(t *testing.T) {
		art := jobdb.NewArtifactFromBytes("test.txt", testData)
	...
	t.Run("reader artifact", func(t *testing.T) {
		art := jobdb.NewArtifactFromReader("test.txt", bytes.NewReader(testData), int64(len(testData)))
		data, err := art.Bytes(ctx)
		require.NoError(t, err)
		assert.Equal(t, testData, data)
...
func TestArtifact_SaveToFile(t *testing.T) {
	...
	t.Run("file artifact", func(t *testing.T) {
		...
		art, err := jobdb.NewArtifactFromFileNoCleanup("test.txt", srcPath)
		require.NoError(t, err)
